...
了解LALR语法分析算法的基本思想，掌握LALR语法分析程序的构造方法。

## 2.设计方法

### 2.1实验原理

LALR分析器是一种规范LR分析方法的简化形式。它可以对上下无关文法进行语法分析。
...
![](https://gitee.com/btbsja/BlogImg/raw/master/blog/2020/03/20200309093345.png){width="5.241666666666666in" height="4.183333333333334in"}
...
![](https://gitee.com/btbsja/BlogImg/raw/master/blog/2020/03/20200309093346.png){width="5.760416666666667in" height="1.6965277777777779in"}

3、输入串分析

i\*i)+i\#

![](https://gitee.com/btbsja/BlogImg/raw/master/blog/2020/03/20200309093347.png){width="6.011111111111111in" height="1.18125in"}

## 4.实验总结

本实验程序较好地完成了LALR分析法分析程序的设计与实现，能够对所给字符串进行识别，判断是否是给定文法的句子。通过这次的实验，我了解了LALR文法预测分析法设计和实现，加深了对LALR文法的理解和认识，使我的编译原理的知识更加巩固，而且可以使理论与实践相结合，更好的掌握所学知识。
