...
了解SLR语法分析算法的基本思想，掌握SLR语法分析程序的构造方法。

## 2.设计方法

### 2.1实验原理

SLR文法分析法就是对LR(0)的一种优化
...
![](https://gitee.com/btbsja/BlogImg/raw/master/blog/2020/03/20200309093336.png){width="4.983333333333333in" height="4.125in"}
...
![](https://gitee.com/btbsja/BlogImg/raw/master/blog/2020/03/20200309093337.png){width="4.5375in" height="2.9784722222222224in"}

非终结符的First follow集合

![](https://gitee.com/btbsja/BlogImg/raw/master/blog/2020/03/20200309093338.png){width="5.233333333333333in" height="1.7416666666666667in"}

项目规范族

![](https://gitee.com/btbsja/BlogImg/raw/master/blog/2020/03/20200309093339.png){width="4.883333333333334in" height="7.991666666666666in"}

构造出的DFA

![](https://gitee.com/btbsja/BlogImg/raw/master/blog/2020/03/20200309093340.png){width="4.4in" height="3.8in"}

SLR文法表和一个例子的文法分析过程

![](https://gitee.com/btbsja/BlogImg/raw/master/blog/2020/03/20200309093341.png){width="5.767361111111111in" height="3.576388888888889in"}

## 4.实验总结

本实验程序较好地完成了SLR(1)分析法分析程序的设计与实现，能够对所给字符串进行识别，判断是否是给定文法的句子,但是SLR解决的冲突只是移进-规约冲突和规约-规约冲突，仍需后续改进。通过这次的实验，我了解了LR(0)文法预测分析法设计和实现，加深了对LR（0）文法的理解和认识，使我的编译原理的知识更加巩固，而且可以使理论与实践相结合，更好的掌握所学知识。
